...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		var formModifyObj = $("form[role='form-modify']");
		console.log(formObj);
		...
		$("#cancel").on("click", function() {
			formModifyObj.attr("method", "get");
			formModifyObj.attr("action", "/board/read");
			formModifyObj.submit();
		});
	});
	//]]>
</script>

<form role="form-modify" action="modify" method="post">
<!--  -->
	<input type="hidden" name="bno" value="${modifyTarget.bno }">
