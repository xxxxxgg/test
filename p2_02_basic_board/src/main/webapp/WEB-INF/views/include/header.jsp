          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="/sboard/registerPage"><i class="fa fa-circle-o"></i> Dashboard register</a></li>
                <li><a href="/sboard/listSearch"><i class="fa fa-circle-o"></i> Dashboard listSearch</a></li>
                <li><a href="/board/listPerPage"><i class="fa fa-circle-o"></i> Dashboard listperpage</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
